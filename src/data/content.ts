...
export const HOME_APPROACH = [
  {
    ...
    title: "Understanding",
    title_cn: "深入理解",
    desc: "We start by listening. Understanding your business, your goals, and your challenges is the foundation of our strategy.",
    desc_cn: "我们从倾听开始。深入了解您的业务、目标和挑战，是我们制定战略的基础。"
  },
  {
    step: "02",
    title: "Strategy",
    title_cn: "制定战略",
    desc: "We don't just quote the law; we apply it. We develop tailored legal strategies that align with your commercial objectives.",
    desc_cn: "我们不只是引用法律，而是应用法律。我们制定与您的商业目标相一致的定制法律策略。"
  },
  {
    step: "03",
    title: "Execution",
    title_cn: "高效执行",
    desc: "With a clear plan in place, we execute with precision, efficiency, and unwavering dedication to achieving the best outcome.",
    desc_cn: "有了清晰的计划，我们以精确、高效和坚定的决心执行，致力于实现最佳结果。"
  }
];
...
export const TESTIMONIALS = [
  {
    ...
    quote_cn: "达观律师事务所在我们复杂的市场准入过程中提供了卓越的法律咨询。他们对当地法规和国际标准的深刻理解是非常宝贵的。",
    author: "CEO",
    author_cn: "首席执行官",
  ...
  },
  {
    ...
    quote_cn: "他们在争议解决方面的战略方针为我们节省了时间和资源。在柬埔寨的关键法律事务上，他们确实是我们值得信赖的合作伙伴。",
    author: "Director",
    author_cn: "董事",
  ...
  },
  {
    ...
    quote_cn: "专业、反应迅速且知识渊博。他们以绝对的精确度为我们的房地产开发导航了监管环境。",
